...
namespace Engine
{
	...
	enum class RENDERGROUP { RG_PRIORITY, RG_NONBLEND, RG_BLEND, RG_UI, RG_UI_BLEND, RG_END };
	...
	enum class GAMEOBJ_TYPE { PLAYER, MONSTER, OBJECT,TERRAIN, WEAPON, POTAL, END_POTAL, EXP, EXPBALL, GOLD, HP, STONE_TABLET, ATIFACT, MERCAHNT, END };
