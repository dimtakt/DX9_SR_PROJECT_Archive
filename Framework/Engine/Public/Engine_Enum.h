...
namespace Engine
{
	...
	enum class GAMEOBJ_TYPE { PLAYER, MONSTER, OBJECT,TERRAIN, WEAPON, POTAL, END_POTAL, EXP, EXPBALL, GOLD, HP, STONE_TABLET, ATIFACT, MERCAHNT, NORMAL_EFFECT, MONSTER_EFFECT, PLAYER_EFFECT, END };
