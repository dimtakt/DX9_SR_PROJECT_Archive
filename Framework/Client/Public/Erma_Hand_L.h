...
class CErma_Hand_L final : public CMonster
{
public:
...
private:
	CErma_Hand_L(LPDIRECT3DDEVICE9 pGraphic_Device);
	CErma_Hand_L(const CErma_Hand_L& Prototype);
	virtual ~CErma_Hand_L() = default;
