...
namespace Client
{
	...
	// SOUND_BGM은 0으로 고정
	enum class CHANNELID { SOUND_BGM, SOUND_BACKGROUND, SOUND_PLAYER, SOUND_MONSTER, SOUND_EFFECT, SOUND_PLAYER_EFFECT, SOUND_MONSTER_EFFECT, SOUND_MONSTER_LONG_EFFECT, SOUND_MONSTER_LONG_EFFECT2, SOUND_MONSTER_LONG_EFFECT3, SOUND_OBJECT, SOUND_PLAYER_WALK, SOUND_UI, ITEM_EFFECT, ITEM_EFFECT2, ITEM_EFFECT3,
