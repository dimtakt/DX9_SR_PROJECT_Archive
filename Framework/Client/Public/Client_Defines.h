...
namespace Client
{
	...
	enum class EVENT_TYPE { PLAYERTSTATCHANGE, UICHANGE, ROOMCHANGE, EXP, GOLD, EVENT_END };
	...
	enum class MONSTER_TYPE_A { MONSTER_DEFAULT, MONSTER_MOLE_A, MONSTER_OINK_A, MONSTER_LASERGHOST_D, MONSTER_BOSS_ERMA, MONSTER_BOSS_ERMA_BODY, MONSTER_BOSS_ERMA_HAND_L, MONSTER_BOSS_ERMA_HAND_R, MONSTER_BOSS_ERMA_HEAD, ERMA_HEAD, MONSTER_BOSS_ASKARD, MONSTER_BOSS_ASKARD_TENTACLE, MONSTER_BOSS_ASKARD_TENTACLE_EX
	};

	// SOUND_BGM은 0으로 고정
	enum class CHANNELID { SOUND_BGM, SOUND_BACKGROUND, SOUND_PLAYER, SOUND_MONSTER, SOUND_EFFECT, SOUND_PLAYER_EFFECT, SOUND_MONSTER_EFFECT, SOUND_MONSTER_LONG_EFFECT, SOUND_MONSTER_LONG_EFFECT2, SOUND_MONSTER_LONG_EFFECT3, SOUND_OBJECT, SOUND_PLAYER_WALK, SOUND_UI, SOUND_END };

	enum class PARTICLE_TYPE { RAIN, FIRE, PARTICLE_END};
