...
namespace Client
{
	...
	// SOUND_BGM은 0으로 고정
	enum class CHANNELID { SOUND_BGM, SOUND_BACKGROUND, SOUND_PLAYER, SOUND_MONSTER, SOUND_EFFECT, SOUND_PLAYER_EFFECT, SOUND_MONSTER_EFFECT, SOUND_MONSTER_LONG_EFFECT, SOUND_OBJECT, SOUND_PLAYER_WALK, SOUND_UI, SOUND_END };

	enum class PARTICLE_TYPE { RAIN, FIRE, DUST, PARTICLE_END};
