...
namespace Client
{
	...
	const vector<MapData> g_MapDB
	{
		...
		MapData(3, LEVEL::LEVEL_STAGE3,	2,	2, {MAP_EVENT::MAP_SHOP,		MAP_EVENT::MAP_MAXHP }, MAP_BOSS::MAP_BOSS_END),
		...
		MapData(7, LEVEL::LEVEL_BOSS1,	4,	3, {MAP_EVENT::MAP_END}, MAP_BOSS::MAP_MAIN_BOSS),
	};
