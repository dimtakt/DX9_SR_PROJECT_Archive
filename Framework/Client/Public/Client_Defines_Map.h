...
namespace Client
{
	...
	const vector<MapData> g_MapDB
	{
		...
		MapData(2, LEVEL::LEVEL_STAGE2,	1,	1, {MAP_EVENT::MAP_SHOP,		MAP_EVENT::MAP_TREE }, MAP_BOSS::MAP_BOSS_END),
		...
		MapData(6, LEVEL::LEVEL_STAGE4,	3,	3, {MAP_EVENT::MAP_TREE,		MAP_EVENT::MAP_EXP }, MAP_BOSS::MAP_BOSS_END),
