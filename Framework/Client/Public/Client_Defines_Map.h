...
namespace Client
{
	...
	enum class MAP_EVENT { MAP_SHOP, MAP_GOLD, MAP_EXP, MAP_SLATE, 
							MAP_ARTEFACT, MAP_MAXHP, MAP_END };
	...
	const vector<MapData> g_MapDB
	{
		...
		MapData(2, LEVEL::LEVEL_STAGE2,	1,	1, {MAP_EVENT::MAP_SHOP,		MAP_EVENT::MAP_MAXHP }, MAP_BOSS::MAP_BOSS_END),

		MapData(3, LEVEL::LEVEL_STAGE3,   2,   2, {MAP_EVENT::MAP_ARTEFACT,      MAP_EVENT::MAP_SLATE}, MAP_BOSS::MAP_BOSS_END),
		MapData(4, LEVEL::LEVEL_STAGE3,   2,   1, {MAP_EVENT::MAP_SHOP,   MAP_EVENT::MAP_MAXHP }, MAP_BOSS::MAP_BOSS_END),

		MapData(5, LEVEL::LEVEL_STAGE4,	3,	4, {MAP_EVENT::MAP_SHOP,		MAP_EVENT::MAP_ARTEFACT }, MAP_BOSS::MAP_BOSS_END),
		MapData(6, LEVEL::LEVEL_STAGE4,	3,	3, {MAP_EVENT::MAP_MAXHP,		MAP_EVENT::MAP_EXP }, MAP_BOSS::MAP_BOSS_END),

		MapData(7, LEVEL::LEVEL_BOSS1,	4,	5, {MAP_EVENT::MAP_END}, MAP_BOSS::MAP_MAIN_BOSS),
	};
