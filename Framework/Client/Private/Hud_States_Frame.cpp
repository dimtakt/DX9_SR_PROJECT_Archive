...
void CHud_States_Frame::FontRender_Switch()
{
	static_cast<CHp_Player*>(m_vecChildren[0])->FontRender_Switch();
	static_cast<CMp_Player*>(m_vecChildren[1])->FontRender_Switch();
}
