...
#pragma region PT_LASER Pattern
            ...
            else if (IS_BETWEEN(iCurPatternFrame, 350, 400))
            {
...
#pragma endregion
            ...
            break;
        case Client::CErma_Hand_L::PATTERN_HAND_L::PT_KEYPATTERN:
        {
...
void CErma_Hand_L::PlayPattern(PATTERN_HAND_L ePattern, _bool isForced)
{
