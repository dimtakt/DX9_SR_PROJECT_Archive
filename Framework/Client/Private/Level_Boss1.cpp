...
HRESULT CLevel_Boss1::Ready_Layer_UI(const _wstring& strLayerTag)
{
	...
	if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(ENUM_CLASS(LEVEL::LEVEL_BOSS1), TEXT("Layer_UI_Event"),
		ENUM_CLASS(LEVEL::LEVEL_STATIC), TEXT("Prototype_GameObject_AZPattern"), &Desc)))
		return E_FAIL;
	return S_OK;
}
